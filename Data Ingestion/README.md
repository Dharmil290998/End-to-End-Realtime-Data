...
This folder defines all source code for the 'Data Ingestion' pipeline:
...
* Take a look at the sample under "sample_users_data_ingestion.py" to get familiar with the syntax.
